...
at a time: upload front/back photos, optionally **analyze** them with AI to
...
src/
  ...
  test/                Vitest suites (163 tests)
supabase/
  migrations/          8 migrations: admin, tables, storage, cert-normalization,
...
supabase db push                                     # applies all 8 migrations in order
