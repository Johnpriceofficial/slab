  ...
  const buildConfirmationRecord = (): PricechartingConfirmation | null => {
    if (pc) {
      ...
      return {
        ...
        candidate_image_type: reviewed && visual!.imageSource === "official_product" ? "catalog_product_image" : "marketplace_offer_image",
    ...
    if (rejected) {
      return {
        ...
        candidate_image_type: rejected.imageSource === "official_product" ? "catalog_product_image" : "marketplace_offer_image",
